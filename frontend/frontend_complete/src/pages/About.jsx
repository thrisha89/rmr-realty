...
const SERVICES = [
  { key: "landSales", icon: "M3 21h18M5 21V10.5L12 4l7 6.5V21M9 21v-8h6v8" },
  { key: "architecture", icon: "M4 21V9l8-6 8 6v12M9 21v-6h6v6M4 12h16" },
  { key: "interiorDesign", icon: "M4 4h16v16H4zM4 9h16M9 9v11" },
];
          ...
          <div className="mt-14 grid gap-6 sm:grid-cols-3">
            {SERVICES.map((s, i) => (
              <Reveal
                ...
                delay={i * 100}
                className="card card-sweep group relative overflow-hidden p-8 text-center"
              >
                <span className="card-top-accent" aria-hidden="true" />
                <div className="icon-badge is-hoverable icon-badge-gold mx-auto mb-6">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
