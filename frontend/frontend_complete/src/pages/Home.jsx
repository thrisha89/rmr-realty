...
const AMENITY_ICONS = [
  { key: "clubHouse", path: "M3 21h18M5 21V10.5L12 4l7 6.5V21M9 21v-6h6v6M9 12h.01M15 12h.01" },
  { key: "childrensPark", path: "M12 3v4M8 21l4-6 4 6M6 13a6 6 0 1112 0c0 2-1.5 3.5-3 4.5H9c-1.5-1-3-2.5-3-4.5z" },
  { key: "overheadTank", path: "M12 2.5c3.2 3.6 6.5 7.6 6.5 11.5a6.5 6.5 0 11-13 0c0-3.9 3.3-7.9 6.5-11.5zM8.5 14.5a3.5 3.5 0 003.5 3.5" },
  { key: "cctv", path: "M4 8l8-3 8 3M6 9v10a2 2 0 002 2h8a2 2 0 002-2V9M9 13a3 3 0 106 0 3 3 0 00-6 0z" },
  { key: "commercialShops", path: "M3 9l1.5-5h15L21 9M4 9h16v10a1 1 0 01-1 1H5a1 1 0 01-1-1V9zM9 20v-6h6v6" },
];
        ...
        <div className="container-content">
          ...
          <div className="mt-12 grid grid-cols-2 gap-6 sm:grid-cols-3 lg:grid-cols-5">
            {AMENITY_ICONS.map((a, i) => (
              <Reveal key={a.key} variant="blur" delay={100 + i * 70} className="card group flex flex-col items-center gap-3 p-6 text-center">
                <div className="icon-badge is-hoverable icon-badge-outline">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.6">
                    <path d={a.path} strokeLinecap="round" strokeLinejoin="round" />
                  </svg>
                </div>
                <span className="text-sm font-medium text-navy-800">{t(`amenitiesPage.${a.key}Label`)}</span>
              </Reveal>
            ))}
          </div>
        </div>
