...
export default function Projects() {
  ...
  return (
    <div>
      ...
      <CtaBand
        eyebrow={t("projectsPage.ctaEyebrow", "Don't See What You Need?")}
        title={t("projectsPage.ctaTitle", "Let's find the right plot for you")}
        subtitle={t(
          "projectsPage.ctaSubtitle",
          "Tell us your budget and preferred location — our team will match you with the right project."
        )}
        bgWord={t("bgWord.projects")}
      />
    </div>
